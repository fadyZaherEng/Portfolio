...
class SocialBannerWidget extends StatelessWidget {
  final String currentLocale;

  const SocialBannerWidget({super.key, required this.currentLocale});

  @override
  Widget build(BuildContext context) {
    final isDarkMode = GetThemeUseCase(injector())() == Constants.dark;
    final iconColor = isDarkMode ? ColorSchemes.white : ColorSchemes.iconBackGround;
    final double spacing = MediaQuery.of(context).size.height * 0.012;

    Widget buildSocialIcon({required IconData icon, required VoidCallback onPressed}) {
    ...
    final socialLinks = [
      {'icon': FontAwesomeIcons.github, 'url': 'https://github.com/fadyZaherEng'},
      ...
      {'icon': FontAwesomeIcons.linkedin, 'url': 'https://www.linkedin.com/in/fadyzaher'},
      {'icon': FontAwesomeIcons.facebook, 'url': 'https://www.facebook.com/share/18gTWiitR2/'},
      {'icon': FontAwesomeIcons.youtube, 'url': 'https://youtube.com/@fadyzaher2980'},
    ];
