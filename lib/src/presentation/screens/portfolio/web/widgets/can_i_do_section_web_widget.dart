...
class WhatCanIDoSectionWebbWidget extends StatefulWidget {
  final bool isVisible;

  const WhatCanIDoSectionWebbWidget({
    super.key,
    required this.isVisible,
  });

  @override
  _WhatCanIDoSectionWebbWidgetState createState() =>
      _WhatCanIDoSectionWebbWidgetState();
}

class _WhatCanIDoSectionWebbWidgetState extends State<WhatCanIDoSectionWebbWidget>
  ...
  @override
  void didUpdateWidget(covariant WhatCanIDoSectionWebbWidget oldWidget) {
