...
class _PortfolioWebScreenState extends BaseState<PortfolioWebScreen>
  ...
  Widget baseBuild(BuildContext context) {
    ...
    final double fontSize = isDarkMode ? 16 : 18;
    ...
    final List<Map<String, dynamic>> menuItems = [
      {"title": S.of(context).home, "index": 0},
      {
        ...
        "index": 1,
        "route": Routes.skillsWeb,
        "screen": const SkillsScreen()
      },
      {
        "title": S.of(context).training,
        "index": 2,
        "route": Routes.trainingWeb,
        "screen": const TrainingScreen()
      },
      {"title": S.of(context).skillsOffer, "index": 3},
      {
        "title": S.of(context).getInTouch,
        "index": 4,
        "route": Routes.touchMe,
        "screen": const TouchMeScreen()
      },
      {"title": S.of(context).myProjects, "index": 5},
      {"title": S.of(context).education, "index": 6},
      {"title": S.of(context).experience, "index": 7},
      {"title": S.of(context).contact, "index": 8},
    ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          SkillsDetailsOfferWidget(key: _scrollKeys[3]),
          MyChapterEducationWidget(key: _scrollKeys[6]),
          MyChaptersCareerWidget(key: _scrollKeys[7]),
          ProjectsWidgets(key: _scrollKeys[5], isDarkMode: isDarkMode),
          ContactMeWidget(key: _scrollKeys[8]),
