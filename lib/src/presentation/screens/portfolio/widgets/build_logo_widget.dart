...
class BuildLogoWidget extends StatefulWidget {
  final double width;
  final double height;
  ...
  @override
  _BuildLogoWidgetState createState() => _BuildLogoWidgetState();
}

class _BuildLogoWidgetState extends State<BuildLogoWidget>
